...
if (isset($_REQUEST['action'])) {
    if ($_REQUEST['action'] == "contact_form_request") {
        ...
        $required_fields = array("name", "email", "message", "subject", "category");
...
//***
        ...
        $category = "<strong>Category</strong>:".$data["category"]."<br />";
        ...
        if (mail($ourMail, $data['subject'], $pre_messagebody_info .= $category . "<strong>Message</strong>" . ": " . $data['message'] .$after_message, $headers)) {
            $result["info"] = "success";
        } else {
